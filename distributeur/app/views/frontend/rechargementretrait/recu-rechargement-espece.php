...
<page  backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
    ...
    <table width="642" align="center" cellpadding="0" cellspacing="3" >
        ...
        <tr>
            <td height="33" colspan="4" align="center" valign="middle" nowrap="nowrap" class="txt_form1" style="text-align:center; text-transform: uppercase;"><b><?= $data['lang']['rechargement_espece2']; ?></b><hr align="center" style="border:#999 solid 2px" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td align="left" valign="middle" class="textNormal"><span class="txt_lister"><?= $this->utils->truncate_carte($data['benef']->telephone); ?></span></td>

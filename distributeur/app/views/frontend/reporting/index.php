...
$rs_servicePaiement = $data['servicePaiement'];
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <ul class="list-inline two-part row">
                        ...
                        <li class="text-right"><span class="" style="font-size: 15px;"><?= $this->utils->number_format($data['nbtransac']->nbtransac); ?></span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <ul class="list-inline two-part">
                        ...
                        <li class="text-right"><span class="" style="font-size: 15px;"><?= $this->utils->number_format($data['nbtransac']->ca).' '.$data['lang']['currency']; ?></span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <ul class="list-inline two-part">
                        ...
                        <li class="text-right"><span class="" style="font-size: 15px;"><?= $this->utils->number_format($data['nbtransac']->commission).' '.$data['lang']['currency']; ?></span></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                <div class="white-box">
                    ...
                    <ul class="list-inline two-part">
                        ...
                        <li class="text-right"><span class="" style="font-size: 15px;"><?= $this->utils->number_format($data['nbtransac']->macommission).' '.$data['lang']['currency']; ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <!--<div class="col-md-12 col-lg-6 col-sm-12 col-xs-12">
                <div class="white-box">
                    ...
                    foreach($data['service'] as $row_rs_service) 
                    {
                        ...
                        {
                            $rechargeransact = $this->utils->montantServiceMensuel($row_rs_service['rowid'],$row_mois,$annee,$bureau,$courbe);
                ...
                <div class="white-box">
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            {
                                $nbre = $this->utils->getnbre($key, $data['user']);
                                if (is_array($nbre))
                                {
                            ...
                            <section id="section-iconbox-2">
                                ...
                                <div class="table-responsive manage-table">
                                    <div class="panel-group col-lg-12 col-sm-12" id="accordion">
                                        ...
                                        {
                                            $rechargeransact11 = $this->utils->montantRechargementMensuel($row_rs_service11['rowid'],$data['user']);
                                            ?>
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title" style="text-align: center;">
                                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?= 'r'.$i11 ?>"><?= $row_rs_service11['label'];?></a>
                                                    </h4>
                                                </div>
                                                <div id="collapse<?= 'r'.$i11 ?>" class="panel-collapse collapse">
...
/*                                          $total_transfert+=$row_cartetoch_mois['mt'];
                            ...
                            <!--<section id="section-iconbox-4">
                                <div class="p-20 row">
                                    <div class="col-sm-6">
                                        <h3 class="m-t-0"><?/*= $data['lang']['paiement']; */?></h3>
                                    </div>
                                    <div class="col-sm-6">
                                        <ul class="side-icon-text pull-right">
                                ...
                                <div class="table-responsive manage-table">
                                    <div class="panel-group col-lg-12 col-sm-12" id="accordionD">
                                        <?php
/*                                        $i111= 1;
                                        $total_service111=0;
                                        $total_frais111=0;
                                        $total_ttc111=0;
                                        foreach($rs_servicePaiement as $row_rs_servicePaiement)
                                        {
                                            $rechargeransact111 = $this->utils->montantPaiementMensuel($row_rs_servicePaiement['rowid'],$agence);
                                            */?>
                                            <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title" style="text-align: center;">
                                                    <a data-toggle="collapse" data-parent="#accordionD" href="#collapse<?/*= $i111 */?>"><?/*= $row_rs_servicePaiement['label'];*/?></a>
                                                </h4>
                                            </div>
                                            <div id="collapse<?/*= $i111 */?>" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    <table class="table">
                                                        <thead>
                                                        <tr bgcolor="#999999" class="advance-table-row">
                                                            <td align="center" colspan="4"><strong><?php /*echo $row_rs_servicePaiement['label']; */?></strong></td>
                                                        </tr>
                                                        <tr style="background-color:#EDEDED" class="advance-table-row">
                                                            <td><strong><?/*= $data['lang']['Mois']; */?></strong></td>
                                                            <td align="right"><strong><?/*= $data['lang']['montant_sans_ttc'] ; */?></strong></td>
...
/*                                                        $total_service111+=$recharge_total111;
                                                        ...
                                                        */?>
                                                        <tr bgcolor="#DDDDDD" class="advance-table-row">
                                                            <td  align="right" valign="middle" >
                                                                <strong><?/*= $data['lang']['montant_total'].' '.$row_rs_servicePaiement['label'];*/?> : </strong>
                                                            </td>
                                                            <td align="right" valign="middle" >

...
<page_header>
    <table width="642">
        <tr>
            <td align="left" valign="middle" style="font-style:italic; color:#CCC;"><p><?= $data['lang']['historique_transaction']; ?> du <?php echo $this->utils->date_fr4($data['date1']); ?>au <?php echo $this->utils->date_fr4($data['date2']); ?></p></td>
            <td>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </p>
...
<table width="642" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr align="center" valign="top" nowrap="nowrap">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $data['lang']['historique_transaction']; ?>  du <?php echo $this->utils->date_fr4($data['date1']); ?>au <?php echo $this->utils->date_fr4($data['date2']); ?>
            &nbsp;&nbsp;&nbsp;&nbsp;
        </td>
  </tr>
</table>
...
<table width="642" border="1" align="center" cellpadding="20" cellspacing="0">
  <tr align="center" valign="top">
        ...
        <td width="13%"><strong><?= $data['lang']['tel']; ?></strong></td>

...
<table width="642" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr align="center" valign="top">
    	<td><strong><?= $data['lang']['date']; ?></strong></td>
        <td><strong><?= $data['lang']['numero']; ?></strong></td>
        <td><strong><?= $data['lang']['tel']; ?></strong></td>
        <td><strong><?= $data['lang']['produit_transac']; ?></strong></td>
        <td><strong><?= $data['lang']['montant_sans_ttc']; ?></strong></td>
        <td><strong><?= $data['lang']['frais']; ?></strong></td>
        <td><strong><?= $data['lang']['montant_ttc']; ?></strong></td>
        <td><strong><?= $data['lang']['effectuer_par']; ?></strong></td>
        <td><strong><?= $data['lang']['agence']; ?></strong></td>
  </tr>
    <?php 
	 $total=0;
	 $totalttc=0;
   ...
   { 
	   ...
	   ?>
			  ...
			  <tr align="center" valign="middle">
					...
					<td align="left"><?php echo $this->utils->truncate_carte($row_transact['telephone']); ?></td>
					<td align="left"><?php echo $row_transact['label']; ?></td>
					...
					<td align="left" style="word-wrap: break-word;width: 100px; min-width:50px;" ><?php echo $row_transact['prenom'].' '.$row_transact['nom']; ?></td>

                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-wrapper collapse in" aria-expanded="false">
                        <div class="panel-body">
                            ...
                            <input type="hidden" id="numserie" value="<?php echo $this->utils->securite_xss($_POST['numserie']) ?>" />
                        </div>
                    </div><!-- /.box-body -->
                    <div class="box-body margin-bottom">
                        <div class="col-xs-6"></div>
                        <div class="col-xs-6">
                            <form action="<?= ROOT ?>reporting/facturedate" method="post" name="form2" target="_blank">
                                ...
                                <input type="hidden" name="numserie" id="numserie" value="<?php echo $this->utils->securite_xss($_POST['numserie']) ; ?>" />
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
        ...
        var dataTable = $('#user-grid').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url : "<?= ROOT ?>reporting/processingdate/"+date1+"/"+date2+"/"+numserie, // json datasource

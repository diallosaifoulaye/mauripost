                ...
                <div class="box">
                    ...
                    <div class="box-body">
                         <div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-12 col-xs-12">
                                <form class="form-horizontal" method="POST" action="<?= ROOT ?>reporting/bordereaurecharge">
                                	<fieldset style="display: block;" class="scheduler-border">
                                        <legend class="scheduler-border"><?= $data['lang']['bordereau_rechargement']; ?></legend>
                                            <div class="form-group">
                                                <label for="region" class="col-sm-5 control-label">
                                                    <?= $data['lang']['nom_agence'].' :' ; ?>
                                                </label>
                                                <div class="col-sm-7">
                                                    <select class="form-control select2" name="agence" style="width: 100%;" id="agence" required>

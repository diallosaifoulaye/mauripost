...
<? $thispage = 'detail_retrait_transfert'; ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= $data['lang']['detail_retrait_tiers']; ?>
        </h1>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
						<?= $data['lang']['detail_retrait_tiers']; ?>: du <?php echo $this->utils->date_fr2($this->utils->securite_xss($_POST['datedeb'])); ?> au <?php echo $this->utils->date_fr2($this->utils->securite_xss($_POST['datefin'])); ?>
                        </h3>
                        ...
                        <div class="table-responsive">
                            <table id="reporting-produit-grid" class="table table-bordered table-hover">
                                ...
                                <tr class="titre_table">
                                    <th><?= $data['lang']['date_paiement']; ?></th>
                                    <th><?= $data['lang']['numero_transaction']; ?></th>
                                    <th><?= $data['lang']['bureau_payeur']; ?></th>
                                    <th><?= $data['lang']['montant_sans_ttc']; ?></th>
                                    <th><?= $data['lang']['nom_envoyeur']; ?></th>
                    ...
                    <div class="box-body margin-bottom">
                            ...
                            <div class="col-xs-6">
                            <form action="<?= ROOT ?>reporting/printdetaildretrait" method="post" name="form2" target="_blank">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
		...
		var dataTable = $('#reporting-produit-grid').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url :"<?= ROOT ?>reporting/processingdetailretrait/"+date1+"/"+date2, // json datasource

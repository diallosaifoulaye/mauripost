                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-offset-3 col-md-6 col-xs-offset-1 col-sm-10">
                            <dl class="dl-horizontal">
                                ...
                                <?php  if($data['detail']->fk_carte != "" || $data['detail']->fk_carte !=null){?>
                               <!-- <dt><?/*= $data['lang']['numero_carte'].': '; */?></dt>-->
                                <dd><?=  $this->utils->truncate_carte($data['detail']->fk_carte); ?></dd>
                                <?php }?>
                                <dt><?= $data['lang']['produit'].': '; ?></dt>
                                <dd><?=  $data['detail']->label;?></dd>

                                <dt><?= $data['lang']['montant_sans_ttc'].': '; ?></dt>
                                <dd><?= $this->utils->number_format($data['detail']->montant);?></dd>
                                <dt><?= $data['lang']['commission'].': '; ?></dt>
                                <dd><?= $this->utils->number_format($data['detail']->commission); ?></dd>
                                <dt><?= $data['lang']['montant_ttc'].': '; ?></dt>
                                <dd><?= $this->utils->number_format($data['detail']->montant+$data['detail']->commission); ?></dd>

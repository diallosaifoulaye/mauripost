            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">
						<?= $data['lang']['detail_retrait_titulaire']; ?>: du <?php echo $this->utils->date_fr2($this->utils->securite_xss($_POST['datedeb'])); ?> au <?php echo $this->utils->date_fr2($this->utils->securite_xss($_POST['datefin'])); ?>
                        </h3>
                    ...
                    <div class="box-body margin-bottom">
                            ...
                            <div class="col-xs-6">
                            <form action="<?= ROOT ?>reporting/printdetaildtitulaire" method="post" name="form2" target="_blank">
...
<script type="text/javascript" language="javascript" >
    $(document).ready(function() {
		...
		var dataTable = $('#reporting-produit-grid').DataTable( {
            ...
            "serverSide": true,
            "ajax":{
                url :"<?= ROOT ?>reporting/processingdetailtitulaire/"+date1+"/"+date2, // json datasource

...
<page_header>
    <table width="642">
        <tr>
            ...
            <p><?= $data['lang']['detail_retrait_tiers']; ?> du <?php echo $this->utils->date_fr2($date1); ?> au <?php echo $this->utils->date_fr2($date2); ?></p>
            </td>
            <td>
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="642" border="0" align="center" cellpadding="0" cellspacing="0" style="font-weight:bold; font-size:16px">
  <tr align="center" valign="top" nowrap="nowrap">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $data['lang']['detail_retrait_tiers']; ?> du <?php echo $this->utils->date_fr2($date1); ?> au <?php echo $this->utils->date_fr2($date2); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </td>
  </tr>
</table>
...
<table width="642" border="1" align="center" cellpadding="20" cellspacing="0" style="font-size:12px">
  <tr align="center" valign="top" >
          ...
          <th style="font-weight:bold"><?= $data['lang']['nom_envoyeur']; ?></th>
   ...
   foreach($data['recu'] as $row_transact)
   {
	   ...
	   ?>
        <tr align="center" valign="middle">
            <td><?php echo $this->utils->date_fr4($row_transact['date_receiver']); ?></td>
            ...
            <td align="right"><?php echo $row_transact['prenom_sender'].' '.$row_transact['nom_sender']; ?></td>
            <td align="right"><?php echo $row_transact["prenom_receiver"].' '.$row_transact["nom_receiver"]; ?></td>
        </tr>
<?php } ?>
    <tfoot>
    <tr style="font-weight: bold">
        <td colspan="2" align="right">TOTAL NET: </td>
        <td colspan="1" align="left"><?= $this->utils->number_format($total).' '.$data['lang']['currency']; ?> </td>
        <td colspan="2" align="right">TOTAL TTC: </td>
        <td colspan="1" align="left"><?= $this->utils->number_format($total+$total_com).' '.$data['lang']['currency']; ?> </td>
    </tr>
    </tfoot>
</table>

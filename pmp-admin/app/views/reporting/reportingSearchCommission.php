            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?= $data['lang']['commission_produit']; ?></h3>

                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-12 col-xs-12">
                            <form class="form-horizontal" method="POST" action="<?= ROOT ?>reporting/commissionParProduit">
                                <fieldset style="display: block;" class="scheduler-border">
                                    <legend class="scheduler-border"><?= $data['lang']['commission_produit']; ?></legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control select2" required name="produit" style="width: 100%;" id="produit">
                                                ...
                                                <option value="0"><?= $data['lang']['all_service'] ; ?></option>
